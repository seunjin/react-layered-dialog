...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      'bg-muted/30 text-xs uppercase tracking-wider text-muted-foreground [&_th]:px-4 [&_th]:py-3 [&_tr]:border-b',
      className
    )}
    {...props}
  />
...
const TableCaption = ({
  ...
  <div
    className={cn('mb-2 px-2 text-sm text-muted-foreground', className)}
    {...props}
  />
);
